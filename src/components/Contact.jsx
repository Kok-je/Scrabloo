    ...
    <div name='contact' className='w-full h-screen flex justify-center items-center p-4'>
        <div className='max-w-[1100px] mx-auto mt-20 sm:px-14 px-6 flex flex-col justify-center w-full h-fit'>
            ...
            <div className="flex justify-center">
                <form method='POST' action="https://getform.io/f/e3fcfe93-80e5-4a72-af51-fc41314b7c13" className='flex flex-col max-w-[600px] w-full'>
                    ...
                    <button className='flex items-center justify-center font-bold rounded-2xl border-2 hover:bg-secondary hover:text-white px-4 py-3 my-8 mx-auto flex items-center w-40'>HMU</button>
                </form>
            </div>
        </div>
    </div>
